...
/*! 
  * Elizabeth @v1.0
  * Copyright 2023 © Framboide
  * Developed by Framber Ereu (https://fb.com/framber.ereu)
  * License GPL
*/
// Selector CSS $
...
var toggle = function toggle(element, className) {
...
var has = function has(element, className) {
...
var clean = function clean(array, className) {
...
(function () {
  ...
  e && t.setAttribute("data-theme", e), document.addEventListener("DOMContentLoaded", function () {
    var o = document.querySelector(".mode-dark");
    e && o.setAttribute("data-set-theme", e), o.addEventListener("click", function () {
      var e = o.dataset.setTheme;
...
var yall = function () {
  ...
  return function (e) {
    var n = (e = e || {}).lazyClass || "lazy",
      ...
      if (e.isIntersecting || e.intersectionRatio) {
        ...
        s in a && o ? a[s](function () {
          ...
          timeout: o
        }) : f(t), t.classList.remove(n), p.unobserve(t), (h = h.filter(function (e) {
          return e != t;
    ...
    if (/baidu|(?:google|bing|yandex|duckduck)bot/i.test(navigator.userAgent)) g(h, f);else if (u in a && u + "Entry" in a) {
      var p = new a[u](function (e) {
        g(e, m);
      }, {
        rootMargin: ("threshold" in e ? e.threshold : 200) + "px 0%"
      });
      g(h, v), g(h, p), i && g(l(e.observeRootSelector || "body"), function (n) {
...
//# sourceMappingURL=elizabeth.js.map